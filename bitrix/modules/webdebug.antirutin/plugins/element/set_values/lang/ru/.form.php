...
$MESS[$strLang.'USE_CUSTOM_PHP'] = 'Заполнить поле/свойство на основе PHP-кода';
	$MESS[$strHint.'USE_CUSTOM_PHP'] = 'Выполнить собственный PHP-код (код должен вернуть значение для сохранения).';
$MESS[$strLang.'PHP_CODE'] = 'PHP-код';
	$MESS[$strHint.'PHP_CODE'] = 'PHP-код (код должен вернуть значение для сохранения).';
