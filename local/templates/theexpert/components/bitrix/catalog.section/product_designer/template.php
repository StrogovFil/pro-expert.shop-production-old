...
$countProduct = 1;
?>
<div id="product_designer" class="catalog-items" data-entity="<?=$containerName?>">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		?>
		<!-- items-container -->
		<!--<div class="main-special-carousel carousel js-carousel-three owl-carousel">-->
		<?
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			$rowItems = array_splice($arResult['ITEMS'], 0, $rowData['COUNT']);
			?>
		<div class="catalog-items-col <?//=$rowData['CLASS']?>" data-entity="items-row"<?if ($countProduct > 3) echo ' style="display: none"'; ?>>
				<?
...
<?if ($countProduct > 3):?>
<div class="person-products-btn">
	<a id="product_designer_more" href="#" class="btn">Показать все</a>
</div>
<?endif?>
<?
if ($showLazyLoad)
