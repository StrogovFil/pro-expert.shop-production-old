...
?>
<script type="text/javascript">var basketJSParams=<?=CUtil::PhpToJSObject($arBasketJSParams);?>;</script>
<?
...
<!--<div class="bx_ordercart_order_pay_center">
	<a href="/" class="back"><?=GetMessage("SALE_BACK")?></a>
	...
	{
		?>
		<a href="javascript:void(0)" onclick="updateBasket();" class="refresh"><?=GetMessage("SALE_REFRESH")?></a>
		<?
	}
	?>
...
<?/*
<section class="question question-dark">
        <div class="container">
            <div class="question-header">
                <div class="h2 question-title">Заказать дизайн проект</div>
                <div class="question-text">Для выяснения деталей и указания точной стоимости с вами свяжется менеджер. Или узнайте подробнее о услуге</div>
            </div>
            <form action="" class="question-form">
                <div class="question-form-row">
                    ...
                    <div class="question-form-col">
                        <label class="form-label form-label-shorttitle">
                            <input type="text" class="form-input js-phone">
                            <span class="form-label-title">Телефон <span class="form-label-note">Введите телефон</span></span>
                        </label>
                    </div>
                </div>
                <label class="form-label form-label-shorttitle">
                    <textarea name="" rows="3" class="form-input"></textarea>
                    <span class="form-label-title">Комментарий</span>
                </label>
                <button class="btn btn-black question-form-btn">Отправить <i class="icon icon-arrow-left"></i></button>
            </form>
        </div>
    </section>
*/?>