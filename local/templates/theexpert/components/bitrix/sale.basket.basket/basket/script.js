...
function showCouponBox(e)
{
	var boxCoupon = BX('bx_ordercart_coupon_box');
	e.style.display = "none";
	boxCoupon.style.display = "block";
}
...
BX.ready(function() {
	...
	var contentPage = BX('content-page');
	contentPage.classList.add("content-page-basket");
});