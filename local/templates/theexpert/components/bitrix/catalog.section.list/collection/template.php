	...
	switch ($arParams['VIEW_MODE'])
	{
		case 'LINE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				<a
					...
					style="color:#F28E16;background-image: url('<? echo $arSection['PICTURE']['SRC']; ?>');"
		...
		case 'TILE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><div class="catalog-items-col" style="text-align: center;"  id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
				<a
					href="<? echo $arSection['SECTION_PAGE_URL']; ?>"
					...
					style=" width: 100%;
                            min-height: 150px;
                            border: none;
                            background-image:url('<? echo $arSection['PICTURE']['SRC']; ?>');"
					title="<? echo $arSection['PICTURE']['TITLE']; ?>"
					> </a><?
