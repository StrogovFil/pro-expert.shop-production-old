...
//print_r($arParams);die;?>
    ...
    <section class="page catalog catalog-bordered">
        <div class="container">
            ...
            <ul class="catalog-menu">
                ...
                <li><a href="#" class="catalog-tabs btn btn-white" data-id="1">Тип помещения</a></li>
                <li><a href="#" class="catalog-tabs btn <?if(isset($_COOKIE['catab']) && $_COOKIE['catab'] == 2){}else{echo('btn-white');}?>" data-id="2">Бренды</a></li>
            </ul>

<div class="catalog-tab catalog-categories" data-id="0" style="display:<?if(isset($_COOKIE['catab']) && $_COOKIE['catab'] == 2){echo('none');}else{}?>">
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"AREA_FILE_SUFFIX" => "",
		"EDIT_TEMPLATE" => "",
		"PATH" => SITE_TEMPLATE_PATH . "/includes/catalog/delivery.php"
	)
);?>
        </div>
    </section>
