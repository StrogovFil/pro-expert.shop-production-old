		...
		<div class="bx_pg_section pg_pagination_num">
			<div class="bx_pagination_page">
                <?if(strstr($page, '/search/') === false):?>
                    <div class="show-block-wrap">
                        ...
                        <div class="show-block-war">
                            ...
                            <a class="pagen-size<?if(strstr($page, 'SIZEN_1=50') !== false):?> is-active<?endif?>" href="<?=$APPLICATION->GetCurPageParam("SIZEN_1=50", array("SIZEN_1"));?>">50</a> /
                            <a class="pagen-size<?if(strstr($page, 'SIZEN_1=100') !== false):?> is-active<?endif?>" href="<?=$APPLICATION->GetCurPageParam("SIZEN_1=100", array("SIZEN_1"));?>">100</a>
                        </div>
                    </div>
                    ...
                    <?
                        if (true === $arResult["bDescPageNumbering"])
                        {
                            ...
                            {
                                ?><a href="<?=$arResult['sUrlPathParams']; ?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>&SIZEN_<?=$arResult["NavNum"]?>=<?=$arResult['NavPageSize']; ?>" title="<? echo GetMessage('nav_prev_title'); ?>"><i class="icon icon-arrow-down ico-prev-nav"></i></a><?
                            }
                            else
                            {
                                ?><i class="icon icon-arrow-down ico-prev-nav"></i><?
                            }
                            ?></li><?
                            ...
                            {
                                ?><a href="<?=$arResult['sUrlPathParams']; ?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>&SIZEN_<?=$arResult["NavNum"]?>=<?=$arResult['NavPageSize']; ?>" title="<? echo GetMessage('nav_next_title'); ?>"><i class="icon icon-arrow-down ico-next-nav"></i></a><?
                            }
                            else
                            {
                                ?><i class="icon icon-arrow-down ico-next-nav"></i><?
                            }
                            ?></li><?
                        }
                        else
                ...
                <?if ($arResult["bShowAll"]) {?>
                    <div class="show-all">
                        <a class="btn" href="<?=$arResult['sUrlPathParams']; ?>SHOWALL_<?=$arResult["NavNum"]?>=1">Показать все</a>
                    </div>
                <?}?>
			</div>
		</div>
