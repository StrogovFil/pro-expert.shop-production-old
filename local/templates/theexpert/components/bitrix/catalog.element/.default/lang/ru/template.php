...
$MESS["CT_BCE_CATALOG_BTN_MESSAGE_BASKET_REDIRECT"] = "Перейти к запросу";
$MESS["CT_BCE_CATALOG_ADD_TO_BASKET_OK"] = "Товар отложен";
...
$MESS["CT_BCE_CATALOG_DELIVERY_TIME"] = "от 14 дней";
$MESS["CT_BCE_CATALOG_HELP_INFORMER"] = "Стоимость указана без учета стоимости доставки, таможенных сборов и НДС, чтобы узнать точную стоимость товара - оформите заказ";
?>
