...
<div class="container">
<h2 class="h1 main-special-title">Разделы <br>
	 каталога</h2>
 ...
 <img src="/local/templates/theexpert/images/office_furniture.jpg" alt="">
			...
			<div class="main-special-item-title">
				<div class="main-special-item-title-inner">
					 Офисная мебель
				</div>
			</div>
 </a>
 ...
 <a href="/catalog/" class="btn btn-brick main-special-btn">Каталог</a>
	...
	Array(
		...
		"COMPATIBLE_MODE" => "Y",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:1:29\",\"DATA\":{\"logic\":\"Equal\",\"value\":1}}]}",
